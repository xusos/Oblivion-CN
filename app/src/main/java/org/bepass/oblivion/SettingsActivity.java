...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Listen to Changes
        endpointLayout.setOnClickListener(v -> (new EditSheet(this, "端点", "endpoint", sheetsCallBack)).start());
        portLayout.setOnClickListener(v -> (new EditSheet(this, "端口", "port", sheetsCallBack)).start());
        licenseLayout.setOnClickListener(v -> (new EditSheet(this, "许可证", "license", sheetsCallBack)).start());
